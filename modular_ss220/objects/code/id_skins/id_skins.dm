...
/obj/item/id_skin/colored/silver
	name = "\improper глянцевая голо-наклейка на карту"
	desc = "Голографическая наклейка на карту, изготовленная из специального материала, имеющая стилизованный глянцевый отблеск. Вы можете выбрать цвет, который она примет."
	pronoun_name = "глянцевую голо-наклейку"
	icon_state = "colored_shiny"
	info = "На ней глянцевая голо-наклейка."
...
/obj/item/id_skin/ussp
	...
	desc = "Партия гордится вами! Возьмите свою миска-рис в ближайшем баре."
	icon_state = "ussp"
...
/obj/item/id_skin/paradise
	...
	info = "Когда вы смотрите на неё, вам становится теплее и уютнее... как дома."
...
/obj/item/id_skin/colored/snake
	name = "\improper бегущая голо-наклейка на карту"
	desc = "Она что-то загружает?"
	icon_state = "snake"
	pronoun_name = "бегущую голо-наклейку"
...
/obj/item/id_skin/terminal
	name = "\improper кибернетическая наклейка на карту"
	desc = "HACKERMAN."
	icon_state = "terminal"
